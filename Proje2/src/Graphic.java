...
public class Graphic extends JFrame {
    ...
    public XYDataset createDataset() {
        ...
        Collections.sort(SudokuSolverFor5Thread.array);
        threadFor5Graphic.add(0, 0);
        for (int i = 0; i < SudokuSolverFor5Thread.array.size(); i++) {
            threadFor5Graphic.add((Number) (SudokuSolverFor5Thread.array.get(i)), i + 1);
        }

        var threadFor10Graphic = new XYSeries("10 Thread");
        Collections.sort(SudokuSolverFor10Thread.array);
        threadFor10Graphic.add(0, 0);
        for (int i = 0; i < SudokuSolverFor10Thread.array.size(); i++) {
            threadFor10Graphic.add((Number) (SudokuSolverFor10Thread.array.get(i)), i + 1);
        }
