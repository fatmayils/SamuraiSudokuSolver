...
public class SamuraiSudokuFrame1 extends JFrame {
    ...
    public static SudokuSolverFor5Thread1 sudokuSolvers[] = new SudokuSolverFor5Thread1[5];
    public static SudokuSolverFor10Thread1 sudokuSolverss[] = new SudokuSolverFor10Thread1[10];

    public SamuraiSudokuFrame1() throws HeadlessException, IOException, Exception {
        ...
        for (int i = 1; i < 6; i++) {
            sudokuSolvers[i - 1] = new SudokuSolverFor5Thread1(i);
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (x == 0) {
                    for (int i = 1; i < 11; i++) {
                        try {
                            try {
                                sudokuSolverss[i - 1] = new SudokuSolverFor10Thread1(i);
                            } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    SamuraiSudokuFrame1 frame = new SamuraiSudokuFrame1();
